...
//    public static RequestQueue newRequestQueue(Context context, HttpStack stack) {
     ...
     * @return
     */
    public static RequestQueue newRequestQueue(Context context, int rawId) {
        if (rawId > 0) {
            return newRequestQueue(context, null, true, rawId);
        }
        return newRequestQueue(context, null, true, 0);
    }
